...
import com.practicaswrest.Dto.ErrorDetalles;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler{
	...
	@ExceptionHandler(VuelosAppException.class)
	public ResponseEntity<ErrorDetalles> manejarBlogAppException(VuelosAppException exception, WebRequest webRequest){
		ErrorDetalles errorDetalles = new ErrorDetalles(new Date(),exception.getMessage(), webRequest.getDescription(false));
